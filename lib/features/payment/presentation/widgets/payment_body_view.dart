...
class PaymentBodyView extends StatefulWidget {
  const PaymentBodyView({super.key, required this.service});

  final ServiceEntity service;

  @override
  State<PaymentBodyView> createState() => _PaymentBodyViewState();
}

class _PaymentBodyViewState extends State<PaymentBodyView> {
    ...
    return InkWell(
      ...
      child: ListView(
        ...
        children: [
          ...
          AppButton(text: 'Bayar', onPressed: () => showDialogConfirm(context))
        ],
      ),
    );
  }
